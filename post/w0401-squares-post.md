...
in designing these icons, I want to use the relationship of four squares to show the different theme. For example, I use 3 big squares to compress the space of the forth square to describe 
